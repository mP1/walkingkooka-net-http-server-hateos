 ...
 */
public interface HateosResourceHandlerTesting2<H extends HateosResourceHandler<I, V, C, X>,
    I extends Comparable<I>,
    V,
    C,
    X extends HateosHandlerContext>
    extends HateosResourceHandlerTesting, PackagePrivateClassTesting<H>,
